...
ClassSession.create(name: 'strength training', time: '3:00 pm', date: '2020-90-09', duration: 'one hour', gym_id: 1, coach_id: 1)
ClassSession.create(name: 'running', time: '11:00 am', date: '2020-90-10', duration: 'one hour', gym_id: 1, coach_id: 1)
ClassSession.create(name: 'swimming', time: '11:00 am', date: '2020-90-11', duration: 'one hour', gym_id: 1, coach_id: 1)
